...
- 🚀 I specialize in using different open-source engines such as **Unreal Engine**, **Godot(GDExtension)** and **Cocos2d-x**, and proprietary engines, leveraging open-source libraries, and focusing on multiplatform game development. My favorite language for bringing these visions to life is **C++**. Its versatility and efficiency empower me to build performant and robust gaming experiences. Additionally, I use scripting languages such as **Lua** for game logic and **Python** for automation.
